...
class BST{
  ...
  public:
    ...
    void readAFacultyFile(string fileName){
      ...
      while(getline(facultyTreeInfo, facultyLine)){
        if(facultyLine == "X\r" || facultyLine == "X\n" || facultyLine == "X"){
          ...
          BSTNode<X>* myTempNode = new BSTNode<Faculty>;
    ...
    void readAStudentFile(string fileName){
...
class RollBackStack{
  private:
    BSTPair* myTreePair0 = new BSTPair;
    BSTPair* myTreePair1 = new BSTPair;
    BSTPair* myTreePair2 = new BSTPair;
    BSTPair* myTreePair3 = new BSTPair;
    BSTPair* myTreePair4 = new BSTPair;
    int count;
  ...
  public:
    ...
    void addTreePair(BSTPair* newTreePair){
      ...
      cout << "****************************" << endl;
      cout << "Tree Pair successfully added" << endl;
    ...
    BSTPair* popTreePair(){
      ...
      if (count == 4){
        ...
        BST<Student>* tempStudentBST = new BST<Student>;
        tempStudentBST.readAStudentFile("myStudentBST4.txt")
        //read faculty text file and create a faculty BST

        // combine the two into a BST Pair
        //return the BST pair
        return myTreePair4;
      } else if (count == 3){
        return myTreePair3;
...
int main(int argc, char *argv[] ){
  ...
  while(getline(facultyTreeInfo, facultyLine)){
    if(facultyLine == "X\r" || facultyLine == "X\n" || facultyLine == "X"){
      ...
      while (validAdvisee == false){
        ...
        /*cout << "Student Advisor: " << (checkStudentNode->data).getAdvisor() << endl;
        cout << "Faculty Advisor: " << tempID << endl; */
  ...
  for (int i = 0; i < studentCount; ++i){
    ...
    if (advisorExists == true){
      ...
      //go through each faculty and check for valid advisees
  ...
  BSTPair* baseTreePair = new BSTPair;

  baseTreePair->fillPair(myStudentBST, myFacultyBST);
  genRollBack->addTreePair(baseTreePair);
